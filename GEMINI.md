...
- Python 3.12 + `FastAPI`, `SQLAlchemy 2.0`, `httpx`, `Pydantic v2` (001-provider-engine)
- Python 3.12 (managed by `uv`) + `FastAPI`, `SQLAlchemy 2.0`, `httpx`, `Pydantic v2`, `structlog` (001-provider-engine)

## Recent Changes

- 001-provider-engine: Added Python 3.12 + `FastAPI`, `SQLAlchemy 2.0`, `httpx`, `Pydantic v2`
